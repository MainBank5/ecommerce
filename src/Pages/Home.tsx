...
const Home = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full overflow-hidden">
        <div className="py-10 flex justify-center items-center px-40 max-md:flex-col">
          ...
          <div className="w-full h-[90%] overflow-hidden md:w-1/2">
            ...
            <div className="mx-2 px-8 flex flex-col ml-20 md:text-center leading-relaxed max-md:w-full ">
               ...
               <Link to="/phones" className="px-10 py-3 border-2 self-center rounded-xl text-xl bg-yellow-300">Shop Now</Link>
            </div>
        </div>
    </div>
  )
